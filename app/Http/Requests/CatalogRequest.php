...
class CatalogRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return match ($this->route()->defaults['catalog']) {
            ...
            'providers' => ['name' => ['required', 'string', 'max:100', Rule::unique('providers')->ignore($this->route('provider'))], 'driver' => ['required', Rule::in(['sample', 'api-football'])], 'weight' => ['required', 'numeric', 'gt:0', 'max:100'], 'is_active' => ['sometimes', 'boolean']],
        };
    }
}
